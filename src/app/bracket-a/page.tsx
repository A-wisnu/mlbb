                        ...
                        <div style={{
                          ...
                          <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                              ...
                              <span>Wasit: {getRefereeForMatch(match.id, 'A').name}</span>
                            </div>
                            <a 
                              href={getWhatsAppLink(getRefereeForMatch(match.id, 'A').phone)}
                              target="_blank"
                            ...
                            >
                              ...
                              <span>{getRefereeForMatch(match.id, 'A').phone}</span>
                            </a>
                          </div>
                        </div>
